...
CREATE TABLE IF NOT EXISTS `connected_load` (
  ...
  `schedule_day` varchar(60) DEFAULT NULL,
...
INSERT INTO `connected_load` (`con_load_id`, `description`, `priority`, `status`, `schedule_day`, `schedule_on`, `schedule_off`, `last_updated`, `user_id`, `image_on`, `image_off`) VALUES
(1, 'Lighting Load for Room 1', 1, 1, 'Mon Tue Wed Thu', '00:02:09', '22:40:51', '2018-05-30 16:45:14', 1, '', ''),
(2, 'Water pump for cottages', 3, 0, 'Fri', '00:39:03', NULL, '2018-05-30 16:39:28', 1, '', ''),
(3, 'Aircon Unit for Room 3', 3, 0, 'Tue Thu', '00:29:03', '00:41:10', '2018-05-30 16:40:07', 1, '', ''),
(4, 'Lighting Loads for Living Room', 1, 0, 'Sun', '00:44:30', '00:43:10', '2018-05-30 16:44:55', 1, '', '');
...
(1, 'A power interruption occurs last May 2, 2018 10:30:40 PM, at +8:00 GMT. ', NULL, 1, '2018-05-02 02:33:10'),
...
(5, 240, 220, 63, 57, 100, 50, 20000, 1500, 0.8, 11.5, 50, 0.716, 900, 230, 60, '2018-05-02', '2018-05-30 16:41:39', 1);
...
(1, 'Longhas', 'Mark Ryan', 'markryan.longhas', '*7726D027DCAAE0DE719D4937EFDB8F598A22B458', 'yanixmrml@gmail.com', '+63995772230', 1, '', 1, '2018-05-30 16:36:27', '2018-04-02 05:10:18'),
...
(8, 'Cabilogan', 'Eryl Kean', 'erylkean.cabilogan', '*55F589B0AACA6C9390A0853B2B4E8B0C819ABBBB', '', '', 0, '', 0, '2018-04-30 16:00:00', '2018-04-12 08:46:07');
COMMIT;
