        <footer id="footer">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <a href='<?php echo base_url(); ?>' title='Proceed to MSU Marawi Campus Website'><img id='atspms-dashboard-logo' src='<?php echo base_url(); ?>/assets/css/images/dashboard-logo.png'></a>
                    </div>
                    <div class="col text-muted" id="footer-left">
                        <?php echo $webTitle; ?><br />
                        This page is maintained by LPD Muskeeters, Inc.
                        College of Engineering,<br/>
                        Mindanao State University,<br/>
                        Marawi City
                        <br /><br/>
                        <b>All rights reserved &copy 2017 LPD Muskeeters, Inc.</b>
                        <?php echo (isset($footer_creator)?$footer_creator:"---"); ?>
                    </div>
                    <div class="col text-muted" id="footer-right">
                        For ATS-PMS related comments and suggestions,
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/bootstrap-dateortimepicker.min.js"></script>
