    ...
    <div class="row">
        <div class="col-md-8" id="login-left-nav">
            ...
            <div id="login-left-footer">
                <p><b>ATS-PMS Dashbaord</b> is a web-based application for Human Machine Interface of Automatic Transfer Switch - Power Management
                System, a proposed research study by Mark Ryan Longhas, Kevin Rey Pame and Jahid Bin Damao of College of Engineering, Mindanao State
